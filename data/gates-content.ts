...
export const gateDetails: Record<string, GateDetail> = {
  moharli: {
    ...
    heroImage:
      '/images/gate-tiger-broadside.jpg',
    metaDescription:
  ...
  agarzari: {
    ...
    heroImage:
      '/images/gate-tiger-on-trail.jpg',
    metaDescription:
